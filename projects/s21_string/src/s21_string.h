...
void s21_parse_xo(char *str, va_list vlist, struct flags *flags, char format,
                  int radix);
void s21_parse_p(char *str, va_list vlist, struct flags *flags, char format,
                 int radix);
void s21_parse_g(char *str, va_list vlist, struct flags *flags, char format);
...
void l_case(char *str, va_list vlist, struct flags *flags);
